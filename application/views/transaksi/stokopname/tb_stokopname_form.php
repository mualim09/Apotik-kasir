...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Stok Opname Detail</h4>
                    <div class="row">
                        ...
                        <div class="form-group col-md-3"><label>Penyimpanan<?php echo form_error('penyimpanan') ?></label>
                            <?=form_dropdown('penyimpanan',['gudang'=>'GUDANG','etalase'=>'ETALASE'],$penyimpanan,' required class="form-control" id="penyimpanan"');?>
                        </div>
...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        ...
        <a href="<?php echo site_url('transaksi/stokopname') ?>" class="btn btn-default">Cancel</a></div>
    </div><!-- /.col -->
</div><!-- /.row --> 
