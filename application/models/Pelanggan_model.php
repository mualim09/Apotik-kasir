...
class Pelanggan_model extends CI_Model
{
    ...
    function get_all()
    {
        ...
        $column_search 	= ['nama','alamat','no_telp'];
        ...
        foreach ($list as $field) {
            ...
            $aksi = 
            anchor(site_url('master/pelanggan/update/'.$field->id_pelanggan),'<i class="mdi mdi-tooltip-edit"></i>',array('title'=>'edit','class'=>'btn btn-info btn-sm'));
            $aksi .= ' ';
            $aksi .= anchor(site_url('master/pelanggan/delete/'.$field->id_pelanggan),'<i class="mdi mdi-delete"></i>','title="delete" class="btn btn-info btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
...
/* Generated by Harviacode Codeigniter CRUD Generator 2019-06-21 00:28:44 */
/* http://harviacode.com */