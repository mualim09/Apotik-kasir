...
class Supplier_model extends CI_Model
{
    ...
    function get_all()
    {
        ...
        $column_search 	= ['nama','alamat','telp'];
        ...
        foreach ($list as $field) {
            ...
            $aksi = 
            anchor(site_url('master/supplier/update/'.$field->id_supplier),'<i class="mdi mdi-tooltip-edit"></i>',array('title'=>'edit','class'=>'btn btn-info btn-sm'));
            $aksi .= ' ';
            $aksi .= anchor(site_url('master/supplier/delete/'.$field->id_supplier),'<i class="mdi mdi-delete"></i>','title="delete" class="btn btn-info btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
...
/* Generated by Harviacode Codeigniter CRUD Generator 2019-06-21 00:29:08 */
/* http://harviacode.com */